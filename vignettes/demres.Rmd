...
The framework was developed to support comparative analyses across species or populations, and thereforeto allow for a fair comparison analyses were conducted with several standardisations that are explained in detail below.
