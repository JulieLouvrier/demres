...
It is therefore important to keep in mind that each metric is calculated relative to the asymptotic growth rate. It is possible to compute it by using the function `eigs` from the package `popdemo` 
