...
*VIK: it would be good to add the lablels to the panels, so they can be referred to directly. Also, consider adding 'Integrating both transient and long-term dynamics' above the third panel. + this figure is too large currently, would be good to modify how it shows up, I guess you can play around for that with some arguments when inserting the figure into rmd*
