...
table.bc.all
```
First, we can notive that the distance measures for maximum attenuation cannot be computed because the population did not attenuate according to the time-constant approach. 
...
```
In this case, the distance measures are much more different. 
