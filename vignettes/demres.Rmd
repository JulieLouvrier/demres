...
We can look at the stable age structure from the function `popdemo::eigs` and create an example scenario in which the initial demographic distribution would differ from its stable structure.
