...
This time we have an object of class __{resil}__ that is a dataframe with 16 columns. 
...
In comparison with the previous table, one can see that the values of _reactivity_, calculated with the time-dependent initial vector converge towards 1 over time. 
