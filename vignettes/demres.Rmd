...
# Plot using ggplot
ggplot(AP_demres_reac_stand, aes(x = timestep, y = reac)) +
  geom_line() +
...
# Plot using ggplot
ggplot(AP_demres_reac, aes(x = timestep, y = reac)) +
  geom_line() +
...
# Plotting demographic resilience metrics over time 
ggplot(AP_demres_stand, aes(x = timestep, y = dr)) +
  geom_line() +
...
ggplot(AP_demres_stand, aes(x = timestep, y = convt )) +
  geom_line() +
