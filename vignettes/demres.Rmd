...
*VIK: I think here we should explain what are the main resilience metrics, how they are computed (formulas) and visualize them as in Capdevila et al. So, this is just a "recap" that, as we discussed during the meeting in Erkner is super-important as many people are not aware of these metrics. So, before introducing the time-varying approach it is essential to explain what metrics are used in the current approach (sensu Capdevila et al)*
...
*VIK: please shift this up to the very beginning - see my comment there. Especially because you here give formulas that for !!standardised!! metrics. Best would be to give the resilience metrics that are calculated with standardisation at the very begin and here to supply the formulas for !!non-standardised!! versions*

The different resilience metrics that can be calculated:  
